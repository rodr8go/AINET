    ...
    <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group heading="Management" class="grid">
                <flux:sidebar.item icon="user-group" href="{{ route('admin.users.index') }}">Manage Users</flux:sidebar.item>
                <flux:sidebar.item icon="users" href="{{ route('admin.customers.index') }}">Manage Customers</flux:sidebar.item>
