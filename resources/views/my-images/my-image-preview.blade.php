<div class="py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <flux:button href="{{ route('my-images.index') }}" icon="arrow-left" variant="subtle"
                     class="text-zinc-400 hover:text-zinc-200 bg-transparent border-transparent hover:bg-zinc-800/50">
            As Minhas Imagens
        </flux:button>
    </div>
            ...
            <div class="flex-1 w-full space-y-6 pt-2 lg:max-w-xl">
                ...
                <div class="space-y-3 pb-2">
                    ...
                    <p class="text-sm text-zinc-400 leading-relaxed">
                        A sua estampa exclusiva aplicada numa t-shirt premium. Escolha a cor e o tamanho.
                    </p>
                </div>
                    ...
                    <div class="space-y-2.5">
                        ...
                        <div class="flex gap-2">
                            ...
                            <label class="relative cursor-pointer select-none">
                                <input type="radio" name="size" value="{{ $size }}" class="sr-only" wire:model.live="selectedSize">
                    ...
                    <div class="space-y-2" x-data="{ count: @entangle('qty').live }">
                        ...
                        <div class="flex items-center bg-zinc-800 border border-zinc-800 w-fit rounded-xl p-1 shadow-md">
                            <button type="button" @click="if(count > 1) count--"
                                    class="w-10 h-10 flex items-center justify-center text-zinc-400 hover:text-zinc-100 hover:bg-zinc-700 rounded-lg font-bold transition select-none">-</button>
