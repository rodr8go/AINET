...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.auth.simple','data' => ['title' => __('Login')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Login'))]); ?>
...
<form method="POST" action="<?php echo e(route('login')); ?>" class="flex flex-col gap-6">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PROJETO\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>