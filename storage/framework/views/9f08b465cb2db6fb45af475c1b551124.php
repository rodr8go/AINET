...
<?php $__env->startComponent('telescope-toolbar::item', ['name' => 'request', 'link' => true]); ?>
    ...
    <?php $__env->slot('text'); ?>
        <div class="sf-toolbar-info-group">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data['method'] !== 'GET'): ?>
            <div class="sf-toolbar-info-piece">
                <b>Method</b>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($data['response']['view'])): ?>
                <div class="sf-toolbar-info-piece">
                    <b>View</b>
                    <span>
...
<?php /**PATH C:\laragon\www\ainet-main\vendor\fruitcake\laravel-telescope-toolbar\src/../resources/views/collectors/request.blade.php ENDPATH**/ ?>