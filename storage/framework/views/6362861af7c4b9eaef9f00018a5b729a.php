...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php echo $__env->make('partials.main-content-headings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('partials.main-content-alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo e($slot); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ainet-main\resources\views/layouts/main-content.blade.php ENDPATH**/ ?>